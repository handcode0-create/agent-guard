...
Principe
L'agent IA n'écrit jamais jamais directement dans ton projet.
...
Pour permettre à Google AI Studio de rediriger automatiquement les fichiers vers le dossier staging de agent-guard, installezinstalle l'extension bridge :.

Accéder aux extensions Ouvrez Chrome et tapez chrome://extensions/ dans la barre d'adresse
Accéder aux extensions
Ouvre Chrome et tape chrome://extensions/ dans la barre d'adresse.

Activer le mode développeur Activez l'interrupteur "Mode développeur" en haut à droite
Activer le mode développeur
Active l'interrupteur "Mode développeur" en haut à droite.

Charger l'extension Cliquez sur "Charger l'extension non empaquetée" et sélectionnez le dossier bridge/extension à la racine de ce dépôt
Charger l'extension
Clique sur "Charger l'extension non empaquetée" et sélectionne le dossier bridge/extension à la racine de ce dépôt.

Lancer le serveur Assurez-vous que le serveur (node bridge/server/server.js) est actif pour réceptionner les fichiers envoyés par l'extension
Lancer le serveur
...
Mode watch : notifications automatiques quand de nouveaux fichiers arrivent dans le staging.
 ...
 Mode approve --interactiveapprove --interactive : diff affiché puis prompt y/n/edity/n/edit fichier par fichier.
Licence
MIT — HANDCODE STUDIO
